...
Game_Bullet.prototype.update = function() {
	//Might Eventually create a bullet stopping command
...
Game_Bullet.prototype.collideCharacter = function(character) {
  ...
  if (this._x - this._collideSize <= character._realX + character._collideW) {
    if (this._x + this._collideSize >= character._realX - character._collideW) {
      if (this._y - this._collideSize <= (character._realY + character._offsetY)) {
        if (this._y + this._collideSize >= (character._realY + character._offsetY) - character._collideH) {
          return true;
        }
      }
    }
...
Game_Player.prototype.refresh = function() {
  ...
  if (actor) {
    this._invincibleTime = actor.loadTagParam('invincible_time', 0);
