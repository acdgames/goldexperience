...
Game_Actor.prototype.getParamAllocateMax = function(paramId) {
  var data = Yanfly.Param.StatAlcParamSettings;
  if (paramId === 0) return data.mhp.maxAllocations  + $gameVariables.value(9);
  if (paramId === 1) return data.mmp.maxAllocations  + $gameVariables.value(9);
  if (paramId === 2) return data.atk.maxAllocations  + $gameVariables.value(9);
  if (paramId === 3) return data.def.maxAllocations  + $gameVariables.value(9);
  if (paramId === 4) return data.mat.maxAllocations  + $gameVariables.value(9);
  if (paramId === 5) return data.mdf.maxAllocations  + $gameVariables.value(9);
  if (paramId === 6) return data.agi.maxAllocations  + $gameVariables.value(9);
  if (paramId === 7) return data.luk.maxAllocations  + $gameVariables.value(9);
  return 100;
};
...
Window_AllocationList.prototype.isParamEnabled = function(param) {
  ...
  var max = this.paramData(param).maxAllocations + $gameVariables.value(9);
