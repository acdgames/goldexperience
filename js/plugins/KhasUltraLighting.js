...
Khas.Lighting.LIGHTS = {
    ...
    outsideclear: {
        fileName: "white",
        intensity: 80, variation: 0, size: 150,
        offset_x: -10, offset_y: -48  
    },
    // TORCH
    torch: {
        fileName: "torch",
    ...
    torch_huge: {
        fileName: "torch",
        intensity: 80, variation: 20, size: 300,
        offset_x: 0, offset_y: 0  
    },
    torch_huge2: {
        fileName: "torch",
        intensity: 100, variation: 0, size: 300,
        offset_x: 0, offset_y: 0  
    },
    white_torch: {
        fileName: "white",
...
blue_candle: {               // This is the light name, must be lowercase. The name is used with the [light x] command.
    fileName: "blue_candle", // A String containing the name of the file in the img/lights folder.
    intensity: 75,      // The light's intensity, an integer from 0 to 100.
    variation: 25,        // The light's variation on intensity. A Random number from 0 to variation is added to the intensity.
    offset_x: 0,         // Offset the light's x position in pixels, use an integer.
    offset_y: 0          // Offset the light's y position in pixels, use an integer.
},
