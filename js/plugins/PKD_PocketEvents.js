...
/*:
 * @plugindesc (v.1.1)[PRO] Allow you spawn Events during game with placement select
...
(function(){
    ...
    ParsePluginItemsList = (arrayList) => {
        ...
        parsed.forEach(element => {
            ...
            // * Проверка, так как параметры были добавлены в обновлении 1.1
...
(function() {
  ...
  _.initialize = function() {
    ...
    this.pGetEPDB(); // * Create
    return this.pGetEPDB2(); // * Create
  };
  _.pGetEPDB = function() {
    if (this.pEPDB == null) {
      this.pEPDB = {};
...
(function() {
  ...
  _.updatePosition = function() {
    if (this.p_dragMode === true) {
      this.x = TouchInput.x;
      this.y = TouchInput.y;
      return this.z = this._character.screenZ();
    } else {
      return ALIAS__updatePosition.call(this);
    }
  };
})();
...
//Plugin PKD_PocketEvents automatic build by MVPluginBuilder 1.8 08.11.2020
